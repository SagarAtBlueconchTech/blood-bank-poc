...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
    ...
    <span class="w3-bar-item w3-right" onclick="location.href = location.href+'/#login" >
    <a href="/#login" class="w3-bar-item w3-button w3-padding "><i class="fa fa-sign-out fa-fw"></i>&nbsp; Log Out</a>
    </span>
</div>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-row-padding w3-margin-bottom" style="display:none">
